                                ...
                                return (
                                    <Form>
                                        <Row>
                                            ...
                                            {motorInsurance && motorInsurance.policytype_id && motorInsurance.policytype_id != '1' ?
                                                <Fragment>
                                                    ...
                                                    <Row className="m-b-25">
                                                        <Col sm={12} md={7}>
                                                            <div className="txtRegistr">Fuel Type<br/>
                                                                <strong>{vehicleDetails && vehicleDetails.varientmodel && fuel[vehicleDetails.varientmodel.fuel_type]} </strong></div>
                                                        </Col>
                                                    </Row>
                                                </div>
                                            </Col>

...
class TwoWheelerVerifyOD extends Component {
    ...
    handleSubmit = (values) => {
        ...
        this.props.loadingStart();
        axios.post('two-wh-stal/previous-vehicle-details', formData).then(res => {
            this.props.loadingStop();
            let decryptResp = JSON.parse(encryption.decrypt(res.data));
            console.log('decryptResp-----', decryptResp)
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(TwoWheelerVerifyOD));
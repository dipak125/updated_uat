    ...
    render() {
        ...
        if(( (motorInsurance && motorInsurance.policytype_id && motorInsurance.policytype_id == '3' && motorInsurance.lapse_duration == '1') ||
            ...
            newInitialValues = Object.assign(initialValue, {
                ...
                insurance_company_id: previousPolicy && previousPolicy[0] && previousPolicy[0].insurancecompany_id ? previousPolicy[0].insurancecompany_id : "",
                ...
                active_insurance_company_id: previousPolicy && previousPolicy[1] && previousPolicy[1].insurancecompany_id ? previousPolicy[1].insurancecompany_id : "",

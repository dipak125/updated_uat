...
class Transcrop_gateway extends Component {
    ...
    handleSubmit = (values) => {
        ...
        axios.post('payment/transcrop-submit', formData).then(res => {
...
export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(Transcrop_gateway)
);

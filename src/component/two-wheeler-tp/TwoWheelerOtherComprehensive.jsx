...
class TwoWheelerOtherComprehensive extends Component {
    ...
    render() {
        ...
        const { productId } = this.props.match.params
        let defaultSliderValue = PolicyArray.length > 0 ? Math.floor(PolicyArray[0].PolicyRiskList[0].IDV_Suggested) : 32578
        let sliderValue = sliderVal
        let minIDV = PolicyArray.length > 0 ? Math.floor(PolicyArray[0].PolicyRiskList[0].MinIDV_Suggested) : 28000
        let maxIDV = PolicyArray.length > 0 ? Math.floor(PolicyArray[0].PolicyRiskList[0].MaxIDV_Suggested) : 35000
                                ...
                                <section className="brand colpd m-b-25">
                                    <div className="d-flex justify-content-left">
                                        <div className="brandhead m-b-10">
                                            <h4 className="m-b-30">Cover Damage to Others  </h4>
                                            <h5>{errMsg}</h5>
                                        </div>
                                    </div>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col sm={12} md={3}>
                                                            <div className="justify-content-left regisBox">
                                                                ...
                                                                <div className="rupee"> ₹ {fulQuoteResp.DuePremium ? fulQuoteResp.DuePremium : 1610}</div>

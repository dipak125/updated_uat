...
const validateFamilyMembers  = Yup.object().shape({
    ...
    .test(
        "18YearsChecking",
        function() {
            return "Age sgould me minium 18 and maximum 45 years"
        },
        function (value) {
            if (value) {
    ...
    dob_7: Yup.string().when(['looking_for_7'], {
        ...
        .test(
            "18YearsChecking",
            function() {
                return "Age sgould be minium 18 years"
            },
            function (value) {
                if (value) {
                    const ageObj = new PersonAge();
...
class InformationYourself extends Component {
   ...
   // formData.append(`gender`, gender);
    ...
    for(let i=0;i<gender_for.length;i++){
        let gender_val = gender_for[i] ? gender_for[i] : familyMembers[i].gender;

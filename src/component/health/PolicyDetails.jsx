...
class PolicyDetails extends Component {
    ...
    policySummery = (productId) => {
        this.props.history.push(`/PolicySummery/${productId}`);
    }
                                ...
                                <section className="brand">
                                    <div className="boxpd">
                                        ...
                                        <div className="brandhead m-b-30">
                                            <h4>Policy Reference Number QASAN001000000003819</h4>
                                        </div>
                                            ...
                                            <Col sm={12} md={9} lg={9}>
                                                ...
                                                <Row>
                                                    ...
                                                    <div className="d-flex justify-content-left resmb">
                                                        ...
                                                        <button className="proceedBtn" onClick= {this.policySummery.bind(this, productId )}>Make Payment</button>
                                                    </div>

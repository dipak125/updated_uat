...
import Tickets from '../support/TicketCount';
                                            ...
                                            <Row>
                                                <Col sm={12}>
                                                    <Nav variant="pills" className="flex-column">
                                                        ...
                                                        <div><Nav.Item><Nav.Link eventKey="first">New Ticket</Nav.Link></Nav.Item></div>
                                                        <div><Nav.Item><Nav.Link eventKey="second">Tickets</Nav.Link></Nav.Item></div>

...
class RegistrationGCV extends Component {
    state = {
        motorInsurance: '',
        regno: '',
        length: 14,
    ...
    fetchSubVehicle = () => {
        ...
        axios.get(`gcv-tp/sub-vehical-list/4`)
            .then(res => {
                let decryptResp = JSON.parse(encryption.decrypt(res.data))
    ...
    fetchFastlane = async (values) => {
        ...
        if (values.check_registration == '2') {
            ...
            formData.append('menumaster_id', '4')
            this.props.loadingStart();
    ...
    handleSubmit = (values) => {
        console.log("cond1",this.state.stop ===1 ,this.state.stop)
        ...
        if (policyHolder_id > 0) {
            if (sessionStorage.getItem('csc_id')) {
                post_data = {
                    ...
                    'bc_token': "5",
                    'page_name': `Registration_GCV_TP/${productId}`,
            ...
            this.props.loadingStart();
            axios
                .post(`gcv-tp/update-registration`, formData)
                .then(res => {
                    let decryptResp = JSON.parse(encryption.decrypt(res.data))
                    console.log("decrypt", decryptResp)
                    this.props.loadingStop();
            ...
            this.props.loadingStart();
            axios
                .post(`gcv-tp/registration`, formData)
                .then(res => {
                    let decryptResp = JSON.parse(encryption.decrypt(res.data))
                    console.log("decrypt", decryptResp)
                ...
                <BaseComponent>
                    ...
                    <div className="page-wrapper">
						...
						<SideNav />
                                ...
                                <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12 infobox regcvt">
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RegistrationGCV));
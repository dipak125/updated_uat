...
class SelectBrandGCV extends Component {
    ...
    getOtherBrands = () => {
        ...
        let encryption = new Encryption();
        axios.get(`gcv-tp/vehicle/brand-without-image/${policyHolder_id}`).then(res => {
            let decryptResp = JSON.parse(encryption.decrypt(res.data));
            console.log('decryptResp', decryptResp)
    ...
    setBrandName = (brand_id) => {
        ...
        let encryption = new Encryption();
        this.props.loadingStart();
        axios.get(`gcv-tp/vehicle/model-with-varient/${brand_id}/${policyHolder_id}`).then(res => {
            let decryptResp = JSON.parse(encryption.decrypt(res.data));
            console.log('decryptResp', decryptResp)
    ...
    update= ()=>{
        ...
        this.props.loadingStart();
        axios.post('gcv-tp/insert-brand-model-varient', formData).then(res => {
            this.props.loadingStop();
    ...
    updatedFetchData=()=>{
        let encryption = new Encryption();
        let policyHolder_id = localStorage.getItem("policyHolder_refNo") ? localStorage.getItem("policyHolder_refNo") : 0;
        axios.get(`gcv-tp/policy-holder/details/${policyHolder_id}`).then(res=>{
    ...
    render() {
        const { brandList, motorInsurance, selectedBrandDetails, brandModelList, selectedBrandId ,seating, gross_vechicle_weight,
                    ...
                    <div className="container-fluid">
					 ...
					 {/*<div className="col-sm-12 col-md-12 col-lg-2 col-xl-2 pd-l-0">        
						<SideNav />
                            ...
                            <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12 infobox sbGcvt">

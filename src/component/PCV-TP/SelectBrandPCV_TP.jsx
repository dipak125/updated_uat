...
class SelectBrandPCV_TP extends Component {
    ...
    updatedFetchData=()=>{
        let encryption = new Encryption();
        let policyHolder_id = localStorage.getItem("policyHolder_refNo") ? localStorage.getItem("policyHolder_refNo") : 0;
        axios.get(`pcv-tp/policy-holder/details/${policyHolder_id}`).then(res=>{
                                                                    ...
                                                                    <input type="radio"
                                                                        ...
                                                                        onClick={(e) =>
                                                                            this.setOtherVarient(e.target.value, model.id, model.brand_id,
                                                                                brand.name, model.name + " " + varient.varient, varient.fuel_type, varient.body_style, varient.carrying, varient)
                                                                        }
                                                                    />
                                                                    <span className="checkmark mL-0"></span>
                                                                    <span className="error-message"></span>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SelectBrandPCV_TP));
...
class OtherComprehensivePCV_TP extends Component {
    ...
    handleSubmit = (values) => {
        ...
        const { motorInsurance, PolicyArray, sliderVal,vahan_flag ,add_more_coverage, bodySliderVal,error,vahan_chasis_no,vahan_engine_no,vahan_message } = this.state
        if(error === 1)
        {
            swal(vahan_message)
        }

...
class AdditionalDetailsPCV extends Component {
    ...
    handleSubmit = (values, actions) => {
        ...
        let post_data = {
            ...
            'page_name': `AdditionalDetails_PCV/${productId}`,
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(AdditionalDetailsPCV));
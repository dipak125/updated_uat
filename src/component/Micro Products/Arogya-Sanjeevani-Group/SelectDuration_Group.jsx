...
class SelectDuration_Group extends Component {
    ...
    medicalQuestions = (productId) => {
        this.props.history.push(`/MedicalDetails_Group/${productId}`);
    }
    ...
    handleSubmit = (values) => {
       ...
       // formData.append('policy_holder_id', localStorage.getItem('policyHolder_id'));
        ...
        else if((serverResponse.HighestFamilySI > 250000) && familyMembers.length == "1"  ) {
            swal("Quote cannot proceed with SI greater than 250000")
            this.props.loadingStop();
            return false
        }
        ...
        const post_data = {
            ...
            'page_name': `SelectDuration_Group/${productId}`
        }
        ...
        .then(res => { 
            this.props.history.push(`/Address_Group/${productId}`);
        })
        .catch(err => {
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12 infobox arg2">
                                <h4 className="text-center mt-3 mb-3">Arogya Sanjeevani Micro Insurance Product – Group</h4>
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(SelectDuration_Group));
...
class NomineeDetails_Group extends Component {
    ...
    handleSubmit = (values, actions) => {
       ...
       // formData.append('is_appointee', this.state.is_appointee);
        ...
        formArr['page_name'] = `NomineeDetails_Group/${productId}`
        let formObj = {}
        ...
        .then(res => { 
            ...
            this.props.history.push(`/PolicyDetails_Group/${productId}`);
        })
        .catch(err => {
            if(err.status == 401) {
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(NomineeDetails_Group));
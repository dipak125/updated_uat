...
class PolicyDetails_Group extends Component {
  state = {
    accessToken: "",
    policyHolderDetails: [],
    familyMember: [],
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12 infobox helpolicy">
                ...
                Arogya Sanjeevani Micro Insurance Product – Group
                </h4>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(PolicyDetails_Group)
);

...
class MedicalDetails_Group extends Component {
    ...
    sumInsured = (productId) => {
        this.props.history.push(`/SelectDuration_Group/${productId}`);
    }
    ...
    //    console.log("AAAAA====>",familyMembers);
       if(answerStr=='n'){
            ...
            let post_data = {
                ...
                'page_name': `MedicalDetails_Group/${productId}`
            ...
            <>
                ...
                <div className="container-fluid">
                    ...
                    <aside className="left-sidebar">
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12 infobox aragyaMedical">
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(MedicalDetails_Group));
...
class Address_Group extends Component {
    ...
    handleSubmit = (values, actions) => {
        ...
        formArr['page_name'] = `Address_Group/${productId}`
        ...
        .then(res => {
           // if(res.data.completedStep == 4){
                this.props.loadingStop();
                this.props.history.push(`/NomineeDetails_Group/${productId}`);
           // }        
        })
        .catch(err => {
            if(err.status == 401) {
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(Address_Group));
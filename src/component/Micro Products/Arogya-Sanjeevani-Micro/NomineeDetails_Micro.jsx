...
class NomineeDetails_Micro extends Component {
    ...
    handleSubmit = (values, actions) => {
       ...
       // formData.append('is_appointee', this.state.is_appointee);
        ...
        .then(res => { 
            ...
            this.props.history.push(`/PolicyDetails_Micro/${productId}`);
        })
        .catch(err => {
            if(err.status == 401) {
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(NomineeDetails_Micro));
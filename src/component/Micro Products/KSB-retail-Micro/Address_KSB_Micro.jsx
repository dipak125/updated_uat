...
class Address_KSB_Micro extends Component {
...
console.log(formArr);
        ...
        .then(res => {
           // if(res.data.completedStep == 4){
                this.props.loadingStop();
                this.props.history.push(`/NomineeDetails_KSB_Micro/${productId}`);
           // }        
        })
        .catch(err => {
            if(err.status == 401) {
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(Address_KSB_Micro));
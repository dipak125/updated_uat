...
class MedicalDetails_KSB_Micro extends Component {
    ...
    sumInsured = (productId) => {
        this.props.history.push(`/SelectDuration_KSB_Micro/${productId}`);
    }
                                        ...
                                        <input type="checkbox"
                                         ...
                                         :
                                           ...
                                           // checked = {values[`question_id_${question.id}`] =='y' ? (values[`family_members_${question.id}`] && values[`family_members_${question.id}`].includes(resource.id.toString())?'checked':''):''}
                                            ...
                                            />
                                             <label for={`family_members.${question.id}.${index}.${resource.relation_with}`}> <img src={require('v../../assets/images/Spouse.svg')} alt=""/>{this.capitalize(resource.relation_with)}</label>
                                            </>:
                                            null                                                                                                                          
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(MedicalDetails_KSB_Micro));
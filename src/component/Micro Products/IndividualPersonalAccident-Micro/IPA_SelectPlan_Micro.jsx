...
class IPA_SelectPlan_Micro extends Component {
  state = {
    accidentDetails: []
  };
      ...
      if(policyHolder_id > 0){
        ...
        formData
          ...
          if(decryptResp.error == false) {
            this.props.history.push(`/AccidentAddDetails_Micro/${this.props.match.params.productId}`);
          }
          else{
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(IPA_SelectPlan_Micro)
);

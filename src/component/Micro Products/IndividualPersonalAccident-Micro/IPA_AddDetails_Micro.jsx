...
class IPA_AddDetails_Micro extends Component {
  state = {
    occupationList: [],
    requestedData: [],
    fulQuoteResp: [],
    ...
    axios
      ...
      .then(res => {
        ...
        if (decryptResp.error == false) {
          this.props.history.push(`/AccidentAdditionalDetails_Micro/${productId}`);
        } else {
          actions.setSubmitting(false)
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(IPA_AddDetails_Micro)
);

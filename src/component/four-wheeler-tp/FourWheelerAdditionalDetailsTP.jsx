...
const ownerValidation = Yup.object().shape({
    ...
    eia_no: Yup.string()
        ...
        .max(13, function() {
            return "EIAMax"
        }).matches(/^[1245][0-9]{0,13}$/,'EIAValidReq').notRequired('EIA no is required'),
        ...
        axios.get(`four-wh-tp/details/${policyHolder_id}`)
            .then(res => {
                ...
                //  console.log("decrypt---", decryptResp)
                 ...
                 let is_loan_account = decryptResp.data.policyHolder ? decryptResp.data.policyHolder.is_carloan : 1

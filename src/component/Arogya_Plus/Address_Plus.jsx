...
class Address_Plus extends Component {
    ...
    handleSubmit = (values, actions) => {
        ...
        formArr['page_name'] = `Address_Plus/${productId}`
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Address_Plus));
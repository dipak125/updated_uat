...
const validateFamilyMembers = Yup.object().shape({
    ...
    dob_4: Yup.string().when(['looking_for_4'], {
        is: looking_for_4 => looking_for_4 == 'father',
    ...
    dob_5: Yup.string().when(['looking_for_5'], {
        is: looking_for_5 => looking_for_5 == 'mother',
    ...
    dob_6: Yup.string().when(['looking_for_6'], {
        is: looking_for_6 => looking_for_6 == 'fatherInLaw',
...
class arogya_InformationYourself extends Component {
    ...
    chanageGender = (value) => {
        ...
        if (display_gender) {
            ...
            display_gender_new[4] = 'm'
            display_gender_new[5] = 'f'
    ...
    handleFormSubmit = (values) => {
        if (values.occupation_id == '193' && (values.occupation_description == null || values.occupation_description == '')) {
            ...
            post_data['page_name'] = `Arogya_Plus/${productId}`
            ...
            if (policyHolder_id > 0) {
                ...
                axios
                    .post(`arogya-plus/update-yourself`, formData)
                    .then(res => {
                ...
                this.props.loadingStart();
                axios
                    .post(`/arogya-plus/yourself`, formData)
                    .then(res => {
                        let decryptResp = JSON.parse(encryption.decrypt(res.data))
                        console.log("decrypt", decryptResp)
                        localStorage.setItem('policyHolder_id', decryptResp.data.policyHolder_id);
    ...
    handleSubmitForm = (values, actions) => {
        ...
        display_gender[4] = this.state.gender ? 'm' : null
        display_gender[5] = this.state.gender ? 'f' : null
    ...
    fetchRelations = () => {
        this.props.loadingStart();
        axios.get(`/arogya-plus/relations`)
            .then(res => {
                                                ...
                                                <Form>
                                                    <div className="customModalfamlyForm">
                                                        ...
                                                        <Modal.Body>
                                                                ...
                                                                <div className="col-md-4">
                                                                    <label className="customCheckBox formGrp formGrp">Father
                                                                        <Field
                                                                            ...
                                                                            checked={values.looking_for_4 == 'father' ? true : false}
                                                                        />
                                                                        <span className="checkmark mL-0"></span>
                                                                        <span className="error-message"></span>
                                                                    </label>
                                                                ...
                                                                <div className="col-md-4">
                                                                    <label className="customCheckBox formGrp formGrp">Mother
                                                                        <Field
                                                                            ...
                                                                            checked={values.looking_for_5 == 'mother' ? true : false}
                                                                        />
                                                                        <span className="checkmark mL-0"></span>
                                                                        <span className="error-message"></span>
                                                                    </label>
                                                                ...
                                                                <div className="col-md-4">
                                                                    <label className="customCheckBox formGrp formGrp">Father in law
                                                                        <Field
                                                                            ...
                                                                            checked={values.looking_for_6 == 'fatherInLaw' ? true : false}
                                                                        />
                                                                        <span className="checkmark mL-0"></span>
                                                                        <span className="error-message"></span>
                                                                    </label>
                                                            ...
                                                            <div className="row dropinput m-b-45">
                                                                <div className="col-md-4">
                                                                    <label className="customCheckBox formGrp formGrp">Mother in law
                                                                        <Field
                                                                            ...
                                                                            checked={values.looking_for_7 == 'motherInLaw' ? true : false}
                                                                        />
                                                                        <span className="checkmark mL-0"></span>
                                                                        <span className="error-message"></span>
                                                                    </label>
                                                                ...
                                                                <div className="col-md-4" >
                                                                    ...
                                                                    />
                                                                        ...
                                                                        {
                                                                            errors.looking_for_0 && touched.looking_for_7 ?                 
                                                            ...
                                                            {values.looking_for_2 || values.looking_for_3 ?
                                                                <div className="row dropinput m-b-20">
                                                                    <div className="col-md-15">
                                                                        <label className="customCheckBox formGrp formGrp">
                                                                            ...
                                                                            <span className="checkmark mL-0"></span>
                                                                            <label className="formGrp error">
                                                                                {errors.confirm && (touched.looking_for_2 || touched.looking_for_3 ) ?
                                                                ...
                                                                : null}
                                                            {(values.looking_for_0 && values.looking_for_1) || values.looking_for_2 || values.looking_for_3 || values.looking_for_4 || values.looking_for_5 || values.looking_for_6 || values.looking_for_7 ?

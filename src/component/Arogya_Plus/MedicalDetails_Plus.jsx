...
class MedicalDetails_Plus extends Component {
    ...
    sumInsured = (productId) => {
        this.props.history.push(`/SelectDuration_Plus/${productId}`);
    }
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(MedicalDetails_Plus));
...
const validatearogya_MedicalDetails = Yup.object().shape({
...
class arogya_MedicalDetails extends Component {
...
export default withRouter (connect( mapStateToProps, mapDispatchToProps)(arogya_MedicalDetails));